...
<section class="row no-gutters app d-none mt-3">
    <div class="col-lg">
    ...
    <div class="col-lg-3 col-md-4">
        <b-calendar block hide-header selected-variant="dark" @selected="reload" v-model="current_date"></b-calendar>
    </div>
</section>
<script>
    new Vue({
        ...
        methods:{
            reload(){
                location = "<?=base_url("/expert/prediction/$user_slug")?>"+`/${this.current_date}`
            },
        }
    })
</script>
